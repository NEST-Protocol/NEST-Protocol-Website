    ...
    return (
      ...
      >
        ...
        <Stack spacing={["22px", "44px"]} align={"center"} zIndex={1}>
          ...
          <HStack spacing={'44px'}>
            <Link rel={'alternate'} hrefLang={'en-gb'} color={'#00A0E9'} fontWeight={600} fontSize={15} href={'/about/faqs/'}>
              FAQs <ChevronRightIcon/>
            </Link>
            <Link rel={'alternate'} hrefLang={'en-gb'} color={'#00A0E9'} fontWeight={600} fontSize={15} href={'/doc/ennestwhitepaper.pdf'} isExternal>
        ...
        {isDesktop ? (
            ...
            <Stack align={"center"} justify={"center"} h={'500px'}>
              <HStack h={'100%'} spacing={'40px'}>
                ...
                <Stack spacing={'25px'} w={'500px'}>
                  ...
                  <HStack spacing={'44px'}>
                    <Link rel={'alternate'} hrefLang={'en-gb'} color={'#00A0E9'} fontWeight={600} fontSize={15} href={'/about/nra/'}>
            ...
            <Stack align={"center"} justify={"center"} h={'500px'}>
              <HStack h={'100%'} spacing={'40px'}>
                ...
                <Stack spacing={'25px'} w={'500px'}>
                  ...
                  <HStack spacing={'44px'}>
                    <Link rel={'alternate'} hrefLang={'en-gb'} color={'#00A0E9'} fontWeight={600} fontSize={15} href={'/blogs/'}>
            ...
            <Stack align={"center"} justify={"center"} h={'500px'}>
              <HStack h={'100%'} spacing={'40px'}>
                ...
                <Stack spacing={'25px'} w={'500px'}>
                  ...
                  <HStack spacing={'44px'}>
                    <Link rel={'alternate'} hrefLang={'en-gb'} color={'#00A0E9'} fontWeight={600} fontSize={15} href={'/docs/PVM-Technical-Reference/'}>
          ...
          <Stack px={'24px'} spacing={'40px'} textAlign={"center"}>
            ...
            <Stack spacing={'20px'} justify={"center"} h={'350px'} w={'full'} py={'28px'}
              ...
              <HStack spacing={'44px'} align={"center"} justify={"center"}>
                <Link rel={'alternate'} hrefLang={'en-gb'} color={'#00A0E9'} fontWeight={600} fontSize={12} href={'/blogs/'}>
                  News <ChevronRightIcon/>
                </Link>
              </HStack>
            </Stack>
            <Stack spacing={'20px'} justify={"center"} h={'350px'} w={'full'} py={'28px'}
              ...
              <HStack spacing={'44px'} align={"center"} justify={"center"}>
                <Link rel={'alternate'} hrefLang={'en-gb'} color={'#00A0E9'} fontWeight={600} fontSize={12} href={'/docs/PVM-Technical-Reference/'}>
                  Developer Docs <ChevronRightIcon/>
                </Link>
              </HStack>
            </Stack>
