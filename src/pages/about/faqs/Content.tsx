import {Link, HStack, SlideFade, Stack, Text, useDisclosure, useMediaQuery} from "@chakra-ui/react";
...
const Content = () => {
  ...
  const nest_concepts = [
    {q: "What is NEST?", a: `NEST Protocol creatively introduces random information flow with a decentralized oracle and tokenizes random information flow through the OMM (omnipotent market maker) mechanism, generating many stochastic assets. The NEST PVM (probabilistic virtual machine), based on basic functions, can program stochastic assets, which applies to a large number of real-world scenarios. An inherent cost mechanism ensures the system supply converges, resulting in a new universal coin with an innate price appreciation logic. The NEST coin provides a whole new development tool and is a creative new asset for the blockchain world.`},
    {
