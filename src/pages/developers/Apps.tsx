...
const Apps = () => {
      ...
      <Stack align={"center"} spacing={0} w={'100%'} alignItems={"center"}>
        <Stack maxW={'1440px'} w={'100%'} spacing={'80px'}>
          <HStack spacing={0} w={'100%'}>
            <Stack
              bgImage={'/image/Developer/Developers_bg_2.jpg'}
  ...
  return (
    <Stack spacing={'35px'}>
      <Stack bgImage={'/image/Developer/Developers_bg_2.jpg'} w={'100%'} h={'375px'} bgRepeat={"no-repeat"}
             align={"center"} justify={"center"} bgSize={"cover"}>
      ...
      <Stack bgImage={'/image/Developer/Developers_bg_3.jpg'} w={'100%'} h={'375px'} bgRepeat={"no-repeat"}
             align={"center"} justify={"center"} bgSize={"cover"}>
